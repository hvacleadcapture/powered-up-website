...
The cheapest version of this job is a panel that already has capacity and a charger going on a wall close to that panel. Short run, open breaker slot, done.

Everything that moves the number moves it away from that. A long run costs more because someone has to get the wire there. Going through finished walls costs more because the wall has to be opened and put back. A detached garage or an outdoor location can mean trenching or a conduit run. And if the panel is full, the panel upgrade becomes the bigger half of the job.

A few things that affect price:

- Distance from panel to charger location
- Whether the garage is attached or detached
- Whether the panel has capacity or needs upgrading
- The amperage of the upgrade if one is needed
- Whether the meter socket or utility connection needs updating
- Whether any trenching or conduit is needed for an outdoor or detached garage install
- The cost of the charger unit itself, if you haven't bought one yet

Micah will give you a straight quote after seeing the job. No surprises built in after the fact. Call or text (508) 622-5919 and he'll set up a time to look.

## Are There Rebates or Incentives Available?

Yes, and they're worth looking into before you pay out of pocket.

There has been a federal tax credit for home EV charger installation. The amounts, the eligibility rules, and the expiration dates on these programs change, and I'm an electrician, not a tax professional. Ask your tax preparer or check the IRS guidance directly for what applies to your situation in the year you install. It can be real money, so it's worth the phone call before you file.
