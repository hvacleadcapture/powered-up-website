...
I pull a permit for this work and coordinate the inspection. Any licensed electrician should be doing the same, and the inspection record protects you when you go to sell the house. The Town of Taunton can confirm what's required for your specific job.
...
The permit and inspection add scheduling time on top of the work itself. How much depends on the town's inspection calendar when your job comes up, so I'll give you a realistic window when we book it.
